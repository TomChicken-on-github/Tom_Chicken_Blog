...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		{
			src: "/favicon/HOSHINO.JPG", // Path of the favicon, relative to the /public directory
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "Server Status",
			url: "https://monitor.tomchicken.icu", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/HOSHINO.JPG", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "Tom_Chicken",
	bio: "時よ止まれ、お前は美しい",
	links: [
		{
